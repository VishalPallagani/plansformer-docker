...
#specifying the location of plansformer model_files
model_path = "./plansformer-4domain/model_files"

instance_prompt = get_prompt("/home/data/domain.pddl", "/home/data/problem.pddl")
